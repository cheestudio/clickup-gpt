  ...
  try {
    ...
    const response = await fetch("https://api.openai.com/v1/chat/completions", {
      ...
      headers: {
        ...
        "Authorization": `Bearer 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`
      },
      body: JSON.stringify({
        model: "gpt-4",
        messages: [
